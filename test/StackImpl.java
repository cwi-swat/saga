...
public class StackImpl extends Vector<Object> implements StackInterface {
  ...
  public Object pop() { Object ret = null;
	...
	{Object history_tmp = ret; history.update(new return_pop(history_tmp)); {Object history_tmp = history_tmp; history.update(new return_pop(history_tmp)); return history_tmp;}} }
}